...
<body>
    ...
    <main>
        <h1 data-i18n="page_title">宝塔注册登录与环境安装教程</h1>
        <p class="intro" data-i18n="page_intro">宝塔是一个运行在服务器操作系统之上的网站管理工具，宝塔首次配置与软件安装，注册登录环境安装部分只需要首次配置一次</p>
        
        <div class="step-section">
            <h3 data-i18n="step1_title">1.1 注册与登录</h3>
            <p data-i18n="step3_desc">在上一篇服务器购买与配置教程中，你已经获取了你自己的宝塔地址+账户密码，点击其中的[外网面板地址]，输入账号密码</p>
            ...
            <p data-i18n="step3_desc">登录到宝塔之后，注册登录，这部分很简单就不做示例了</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_21.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_21.png" alt="宝塔登录与注册">
                </a>
            </div>
            
            
            
            <h3 data-i18n="step1_title">1.2 安装环境</h3>
            <p data-i18n="step3_desc">登录成功之后，打开[外网面板] ->[软件商店]安装mysql，选择[5.7.44]->[极速安装]</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_22.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_22.png" alt="宝塔安装mysql">
                </a>
            </div>
            <p data-i18n="step3_desc">继续：[软件商店]安装Nginx，选择[1.24.0]->[极速安装]</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_24.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_24.png" alt="宝塔安装Nginx">
                </a>
            </div>
            <p data-i18n="step3_desc">继续：[软件商店]安装Php，选择[8.1]->[极速安装]</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_26.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_26.png" alt="宝塔安装php">
                </a>
            </div>
            
            
            <h2 data-i18n="section_server">宝塔创建网站教程</h2>
            
            <p data-i18n="step3_desc">点击[网站]，[PHP项目]，添加站点</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_36.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_36.png" alt="宝塔创建网站教程">
                </a>
            </div>
            <p data-i18n="step3_desc">把刚刚在CloudFlare解析的域名填进来，一行一个</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_37.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_37.png" alt="宝塔制作网站教程">
                </a>
            </div>
            
            
            <p data-i18n="step3_desc">之后点击[设置]->[SSL]->[Let's Encrypt]->[文件验证]->[全选]->[申请证书]</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_38.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_38.png" alt="宝塔设置ssl证书教程">
                </a>
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_39.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_39.png" alt="宝塔设置ssl证书教程">
                </a>
            </div>
            <p data-i18n="step3_desc">申请证书后，找到[伪静态]->[thinkphp]，等到编辑框出现了几行代码之后，点击保存即可！</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_40.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_40.png" alt="宝塔设置伪静态教程">
                </a>
            </div>
            <p data-i18n="step3_desc"></p>
            <div class="image-container">
