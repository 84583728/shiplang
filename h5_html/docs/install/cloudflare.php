...
<body>
    ...
    <main>
        <h1 data-i18n="page_title">CloudFlare域名注册教程</h1>
        <p class="intro" data-i18n="page_intro">CloudFlare是全球购买和解析域名的平台，域名是按年计费的，有便宜有贵的推荐注册[.com]结尾的域名是最标准国际化的</p>

        
        <div class="step-section">
            <h3 data-i18n="step1_title">1.1 注册与购买</h3>
            <p data-i18n="step1_desc">注册或登录我就不赘述了：https://dash.cloudflare.com/login</p>
            <p data-i18n="step1_desc">注册成功后，点击[域注册]->[注册域]，在此处可以搜索注册域名</p>
            <p data-i18n="step1_desc">但是注册域名需要付款美金，可以去咸鱼搜索[海外代付][万事达][visa]之类的找个代付也行，也可以去招商银行办一张[万事达储蓄卡]理由是出国旅游即可</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_28.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_28.png" alt="cloudflare注册域名教程">
                </a>
            </div>
            
            <p data-i18n="step1_desc">国家选择：[United States]</p>
            <p data-i18n="step1_desc">美国地址与邮编，打开这个网址获取：https://www.meiguodizhi.com/</p>
            <p data-i18n="step1_desc">获取之后一一对应填进去</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_31.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_31.png" alt="填写美国地址">
                </a>
            </div>
            
            <p data-i18n="step3_desc">接下来就是填写万事达银行卡号、日期、CVV，帐户类型[个人]，付款即可</p>
            <p data-i18n="step3_desc">购买成功之后，点击[账户主页]，点击你购买的域名</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_32.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_32.png" alt="cloudflare找到域名">
                </a>
            </div>
            
            <p data-i18n="step3_desc">[DNS]->[记录]->[添加记录]，把域名指向服务器</p>
            
            <p data-i18n="step3_desc">添加第一条记录：类型A，名称www，ipv4地址填入你自己的外网面板的ip，代理状态打开</p>
            <p data-i18n="step3_desc">添加第二条记录：类型A，名称@，ipv4地址填入你自己的外网面板的ip，代理状态打开，域名注册与解析教程完毕！</p>
            <div class="image-container">
                <a href="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_35.png" target="_blank" class="image-link">
                    <img src="https://pub-8422861cad374e55bcd2985b86a272c1.r2.dev/Screenshot_35.png" alt="cloudflare添加域名解析记录">
                </a>
            </div>
        </div>
    </main>
    <footer>
        <div class="footer-content">
            <ul class="footer-links">
                <li><a href="#" data-i18n="footer_example">示例</a></li>
                <li><a href="#" data-i18n="footer_docs">文档</a></li>
                <li><a href="#" data-i18n="footer_privacy">隐私政策</a></li>
                <li><a href="#" data-i18n="footer_terms">服务条款</a></li>
            </ul>
            <p class="footer-bottom">Email: 9723331@gmail.com</p>
        </div>
    </footer>
</body>
</html>